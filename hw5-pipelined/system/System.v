...
module DatapathPipelined (
					...
					3'b100:
						if (x_funct7 == 7'd1) begin
							if (x_rs2_fwd == 32'd0)
								...
								x_alu_result = (x_rs1_fwd[31] ^ x_rs2_fwd[31] ? ~div_quotient + 32'd1 : div_quotient);
							end
						end
						else
							x_alu_result = x_rs1_fwd ^ x_rs2_fwd;
	...
	wire load_use_stall = (x_is_load && (execute_state[137-:5] != 5'd0)) && ((execute_state[137-:5] == d_rs1) || (execute_state[137-:5] == d_rs2));
	...
	always @(posedge clk)
		if (rst)
			...
			memory_state <= {sv2v_cast_32(execute_state[307-:32]), sv2v_cast_32(execute_state[275-:32]), x_cycle_status_out, x_alu_result, x_store_data, sv2v_cast_5(execute_state[137-:5]), x_rf_we && !div_stall, x_halt && !div_stall};
			...
			case (m_funct3)
				3'b000:
					case (memory_state[40:39])
						2'b00: begin
							store_data_to_dmem = {24'd0, memory_state[14:7]};
							store_we_to_dmem = 4'b0001;
						end
						2'b01: begin
							store_data_to_dmem = {16'd0, memory_state[14:7], 8'd0};
							store_we_to_dmem = 4'b0010;
						end
						2'b10: begin
							store_data_to_dmem = {8'd0, memory_state[14:7], 16'd0};
							store_we_to_dmem = 4'b0100;
						end
						2'b11: begin
							store_data_to_dmem = {memory_state[14:7], 24'd0};
				...
				3'b001:
					case (memory_state[40])
						1'b0: begin
							store_data_to_dmem = {16'd0, memory_state[22:7]};
							store_we_to_dmem = 4'b0011;
						end
						1'b1: begin
							store_data_to_dmem = {memory_state[22:7], 16'd0};
							store_we_to_dmem = 4'b1100;
						end
						default: store_we_to_dmem = 4'b0000;
					endcase
				3'b010: begin
					store_data_to_dmem = memory_state[38-:32];

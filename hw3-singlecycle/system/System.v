...
module DividerUnsigned (
	...
	assign remainder[0] = 32'b00000000000000000000000000000000;
	assign quotient[0] = 32'b00000000000000000000000000000000;
	genvar _gv_i_1;
	generate
		for (_gv_i_1 = 0; _gv_i_1 < 32; _gv_i_1 = _gv_i_1 + 1) begin : div_stage
...
module DatapathSingleCycle (
	...
	wire [31:0] cla_sum;
	reg cla_cin;
	wire is_add_sub_addi = ((insn_opcode == OpRegImm) && (insn_funct3 == 3'b000)) || (((insn_opcode == OpRegReg) && (insn_funct3 == 3'b000)) && ((insn_funct7 == 7'd0) || (insn_funct7 == 7'b0100000)));
	...
	wire is_div_or_rem = ((insn_opcode == OpRegReg) && (insn_funct7 == 7'd1)) && insn_funct3[2];
